...
const NavBar = () => {
   ...
   return (
      <div className=" z-10 flex justify-between items-center w-full px-4 text-white bg-black md:fixed">
         <div>
         ...
         <div>
            <ul className="hidden md:flex">
               {links.map(({ id, title, link }) => (
                  <li
                     key={id}
                     className="px-6 cursor-pointer capitalize font-medium text-gray-500 hover:scale-105 hover:text-white duration-200 "
                  >
